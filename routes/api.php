...
Route::middleware('auth:api')->group(function () {
    ...
    //wishlist routes
    Route::get('showWishlist',[WishlistController::class,'index'])->name('showWishlist');
    // Route::delete('deleteWishlist', [WishlistController::class, 'destroy']); 
    // Route::post('addWishList/{id}',[WishlistController::class,'store']);
    Route::patch('toggleWishlist/{id}',[WishlistController::class,'toggle'])->name('toggleWishlist');
